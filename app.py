...
# Inicia o app
st.set_page_config(
    page_title="Assistente de análise de dados com IA", layout="centered")
...
arquivo_carregado = st.file_uploader(
    "Selecione um arquivo CSV", type="csv", label_visibility="collapsed")
...
# -----------------------------------------------------------
# Criando ações rápidas para relatórios
# AÇÕES RÁPIDAS
st.markdown("---")
...
if st.button("📄 Relatório de informações gerais", key="botao_relatorio_geral"):
    with st.spinner("Gerando relatório 🧞"):
        resposta = orquestrador.invoke(
            {"input": "Quero um relatório com informações sobre os dados",
             "df_head": df_head})
...
# -----------------------------------------------------------
# Criando gráficos com base em perguntas
# GERAÇÃO DE GRÁFICOS
st.markdown("---")
